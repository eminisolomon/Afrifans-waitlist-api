                ...
                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      Our team is dedicated to providing a safe and reliable platform for all your USDT needs. 
                      We implement robust security measures and comply with industry standards to ensure that your transactions are secure and your data is protected.
                      </p>
                      ...
                      Thank you for choosing Flowday App!</br>
                      If you have any questions or need help getting started, please don't
                      hesitate to reach out to us.
                      </p>
                      </br>
                      <p>Email: <a href="mailto:support@flowday.net" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">support@flowday.net</a>.
                      </p>
                      <p>
                      Phone: 08130690998
                      </p>
                  ...
                  <a href="https://www.medium.com"><i class="fa fa-medium social-media-icon medium-icon"></i></a>
	                <a href="https://www.whatsapp.com"><i class="fa fa-whatsapp social-media-icon whatsapp-icon"></i></a>
                  ...
                  <center> &copy; 2023 Flowday LLC. All rights reserved.
                  <br />
                  FCT Abuja, Nigeria.</center></p>
              </td>
            </tr>
          </table>
        </td>
